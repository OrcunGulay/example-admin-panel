        ...
        try {
            post('/api/admin/horoscope-add', {
                ...
                if (res.result) {
                    ...
                    formData.append('fileName', `RedHoroscope/${res.id}`);

                    const formData2 = new FormData();
                    formData2.append('image', imageWObject);
                    formData2.append('fileName', `WhiteHoroscape/${res.id}`);

                    const formData3 = new FormData();
                    formData3.append('image', imageOObject);
                    formData3.append('fileName', `OrangeHoroscape/${res.id}`);

                    const formData4 = new FormData();
                    formData4.append('image', imageDObject);
                    formData4.append('fileName', `DifferentHoroscape/${res.id}`);
        ...
        <CForm style={{ backgroundColor: "white", padding: "50px" }}>
            ...
            <div style={{
                ...
                <div style={{
                    ...
                    <img src={selectedDImage ? selectedDImage : image} alt="image" style={{ width: '200px', height: '200px' }} />
                ...
                <div style={{
                    ...
                    <img src={selectedRImage ? selectedRImage : image} alt="image" style={{ width: '100px', height: '100px' }} />
                    <CTableDataCell className="text-center">
                        <CFormInput
                            type="file"
                            name="image"
                ...
                <div style={{
                    ...
                    <img src={selectedWImage ? selectedWImage : image} alt="image" style={{ width: '100px', height: '100px' }} />
                    <CTableDataCell className="text-center">
                        <CFormInput
                            type="file"
                            name="image"
                ...
                <div style={{
                    ...
                    <img src={selectedOImage ? selectedOImage : image} alt="image" style={{ width: '100px', height: '100px', backgroundColor: "gray", borderRadius: "20px" }} />
                    <CTableDataCell className="text-center">
                        <CFormInput
                            type="file"
                            name="image"
            ...
            <CForm style={{ width: "80%" }}>
                <CFormLabel htmlFor="exampleFormControlTextarea1">Burcun Erkeğe Ait Özellikleri </CFormLabel>
                <CFormTextarea id="exampleFormControlTextarea1" rows={3} onChange={(e) => {
                    setManDesc(e.target.value)
                }}></CFormTextarea>
                <br />
                <CFormLabel htmlFor="exampleFormControlTextarea1">Burcun Kadına Ait Özellikleri</CFormLabel>
                <CFormTextarea id="exampleFormControlTextarea1" rows={3}
                    onChange={(e) => {
                        setWomanDesc(e.target.value)
                    }}></CFormTextarea>
                <br />
                <CFormLabel htmlFor="exampleFormControlTextarea1">Burcun Genel Özellikleri</CFormLabel>
                <CFormTextarea id="exampleFormControlTextarea1" rows={3}
                    onChange={(e) => {
